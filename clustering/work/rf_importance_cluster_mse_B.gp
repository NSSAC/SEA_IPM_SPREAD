...
##### output
set output 'rf_importance_cluster_mse_B.tex'
...
set xlabel "\\%IncMSE (\$\\times 10^3\$)" offset 0,0 font ",18"
set ylabel "" offset -2,0 font ",18"


unset title;        set ytics textcolor 'black' offset .5,0;        set xtics font ",15";        set style data points;        set format x "%.1s";        set nokey;

plot '< gsort -t, -k2,2 -n -r rf_importance_cluster_all_B.csv' u 2:(-$0):yticlabel(1) ls 3 pt 7

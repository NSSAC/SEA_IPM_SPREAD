...
def sampleAvgGroupDistance(vectorList1,vectorList2,sampleSize):
...
if __name__=="__main__":
    ...
    [avg,var]=sampleAvgGroupDistance(classA,classA,SAMPLE_SIZE)
    print "A,A:",avg,var

    # distance within class B
    [avg,var]=sampleAvgGroupDistance(classB,classB,SAMPLE_SIZE)
    print "B,B:",avg,var

    # distance between class A & B
    [avg,var]=sampleAvgGroupDistance(classA,classB,SAMPLE_SIZE)
    print "A,B:",avg,var

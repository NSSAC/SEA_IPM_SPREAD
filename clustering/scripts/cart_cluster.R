...
df <- data.frame(dt)
fit=rpart(DV~beta+kappa+season_ind+start_month+moore+latency_period+alpha_sd+alpha_fm+alpha_ld+time_window, method="anova", data=df, control=rpart.control(minsplit=50, minbucket=20))

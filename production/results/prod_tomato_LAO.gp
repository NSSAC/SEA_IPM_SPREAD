...
##### output
set output 'prod_tomato_LAO.tex'
...
unset title; unset xlabel; unset mxtics; unset mytics;        set xtic rotate by -30 offset -2,-.5 scale 0 autojustify;        set key r t width 8;        set style rect fc lt -1 fs transparent solid 0.15 noborder;        set obj rect from 11, graph 0 to 13, graph 1;        set obj rect from 1, graph 0 to 5, graph 1;        set label "\\parbox{4cm}{Tomato season}" at 12,graph 0 rotate by 90 left;        set xrange [1:13];        set xtics ("Jan" 1,"Feb" 2,"Mar" 3,"Apr" 4,"May" 5,       "Jun" 6,"Jul" 7,"Aug" 8,"Sep" 9,"Oct" 10,"Nov" 11,"Dec" 12) offset 0.5,0;

set style fill transparent solid .5;       plot       'vientiane.csv' u 1:3 ti 'Vientiane'

...
##### output
set output 'prod_tomato_IDN.tex'
...
unset title; unset xlabel; unset mxtics; unset mytics;        set xtic rotate by -30 offset -2,-.5 scale 0 autojustify;        set key l t width 8;        set style rect fc lt -1 fs transparent solid 0.15 noborder;        set obj rect from 5, graph 0 to 10, graph 1;        set label "\\parbox{2cm}{Growing}" at 7.5,graph 0 rotate by 90 left;        set style rect fc lt -1 fs transparent solid 0.25 noborder;        set obj rect from 10, graph 0 to 12, graph 1;        set label "\\parbox{2cm}{Harvesting}" at 10.5,graph 0 rotate by 90 left;        set xrange [1:13];        set xtics ("Jan" 1,"Feb" 2,"Mar" 3,"Apr" 4,"May" 5,       "Jun" 6,"Jul" 7,"Aug" 8,"Sep" 9,"Oct" 10,"Nov" 11,"Dec" 12) offset 0.5,0;

set style fill transparent solid .5;       plot       'pangalengan.csv' u 1:3 ti 'Pangalengan'

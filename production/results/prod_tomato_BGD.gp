...
##### output
set output 'prod_tomato_BGD.tex'
...
unset title; unset xlabel; unset mxtics; unset mytics;        set xtic rotate by -30 offset -2,-.5 scale 0 autojustify;        set style rect fc lt -1 fs transparent solid 0.15 noborder;        set obj rect from 8, graph 0 to 12, graph 1;        set label "\\parbox{2cm}{Sowing \\& transplanting}" at 9,graph 0.5;        set style rect fc lt -1 fs transparent solid 0.25 noborder;        set obj rect from 12, graph 0 to 13, graph 1;        set obj rect from 1, graph 0 to 2, graph 1;        set label "\\parbox{2cm}{Harvesting}" at 1.5,graph 0 rotate by 90 left;        set label "\\parbox{2cm}{Harvesting}" at 12.5,graph 0 rotate by 90 left;        set key c t width 8;        set xrange [1:13];        set xtics ("Jan" 1,"Feb" 2,"Mar" 3,"Apr" 4,"May" 5,       "Jun" 6,"Jul" 7,"Aug" 8,"Sep" 9,"Oct" 10,"Nov" 11,"Dec" 12) offset 0.5,0;

set style fill transparent solid .5;       plot       'rangpur.csv' u 1:3 ti 'Rangpur',       'dhaka.csv' u 1:3 ti 'Dhaka',       'chittagong.csv' u 1:3 ti 'Chittagong',       'khulna.csv' u 1:3 ti 'Khulna',       'rajshahi.csv' u 1:3 ti 'Rajshahi'

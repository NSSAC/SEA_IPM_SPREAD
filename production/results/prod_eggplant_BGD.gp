...
##### output
set output 'prod_eggplant_BGD.tex'
...
unset title; unset xlabel; unset mxtics; unset mytics;        set xtic rotate by -30 offset -2,-.5 scale 0 autojustify;        set key c t width 13;        set xrange [1:13];        set xtics ("Jan" 1,"Feb" 2,"Mar" 3,"Apr" 4,"May" 5,       "Jun" 6,"Jul" 7,"Aug" 8,"Sep" 9,"Oct" 10,"Nov" 11,"Dec" 12) offset 0.5,0;

plot       'rangpur.csv' u 1:3 ls 1 pt 5 ti 'Rangpur model',       'Rangpur_eggplant.csv' u 1:2 ls 1 pt 4 ti 'Rangpur reference',       'dhaka.csv' u 1:3 ls 2 pt 9 ti 'Dhaka model',       'Dhaka_eggplant.csv' u 1:2 ls 2 pt 8 ti 'Dhaka reference',       'chittagong.csv' u 1:3 ls 3 pt 11 ti 'Chittagong model',       'Chittagong_eggplant.csv' u 1:2 ls 3 pt 10 ti 'Chittagong reference',       'khulna.csv' u 1:3 ls 4 pt 13 ti 'Khulna model',       'Khulna_eggplant.csv' u 1:2 ls 4 pt 12 ti 'Khulna reference',       'rajshahi.csv' u 1:3 ls 5 pt 3 ti 'Rajshahi model',       'Rajshahi_eggplant.csv' u 1:2 ls 5 pt 2 ti 'Rajshahi reference'

...
##### output
set output 'prod_potato_BGD.tex'
...
unset title; unset xlabel; unset mxtics; unset mytics;        set xtic rotate by -30 offset -2,-.5 scale 0 autojustify;        set style rect fc lt -1 fs transparent solid 0.15 noborder;        set obj rect from 9, graph 0 to 13, graph 1;        set label "\\parbox{2cm}{Sowing \\& transplanting}" at 9,graph 0.5;        set style rect fc lt -1 fs transparent solid 0.25 noborder;        set obj rect from 1, graph 0 to 4, graph 1;        set label "\\parbox{2cm}{Harvesting}" at 1.5,graph 0 rotate by 90 left;        set key c t width 8;        set xrange [1:13];        set xtics ("Jan" 1,"Feb" 2,"Mar" 3,"Apr" 4,"May" 5,       "Jun" 6,"Jul" 7,"Aug" 8,"Sep" 9,"Oct" 10,"Nov" 11,"Dec" 12) offset 0.5,0;

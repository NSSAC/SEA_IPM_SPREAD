...
##### output
set output 'prod_tomato_PHL_exceptions.tex'
...
plot       'cagayan.csv' u 1:2 ls 1 pt 5 ti 'Cagayan model',       'cagayan_ref.csv' u 1:2 ls 1 pt 4 ti 'Cagayan reference',       'nm.csv' u 1:2 ls 4 pt 13 ti 'Nor. Mind. model',       'nm_ref.csv' u 1:2 ls 4 pt 12 ti 'Nor. Mind. reference',       'davao.csv' u 1:2 ls 5 pt 3 ti 'Davao model',       'davao_ref.csv' u 1:2 ls 5 pt 2 ti 'Davao reference',       'cv.csv' u 1:2 ls 3 pt 11 ti 'Cent. Vis. model',       'cv_ref.csv' u 1:2 ls 3 pt 10 ti 'Cent. Vis. reference'

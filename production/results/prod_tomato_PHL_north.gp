...
##### output
set output 'prod_tomato_PHL_north.tex'
...
unset title; unset xlabel; unset mxtics; unset mytics;        set xtic rotate by -30 offset -2,-.5 scale 0 autojustify;        set key r t width 13;        set xrange [1:13];        set xtics ("Jan" 1,"Feb" 2,"Mar" 3,"Apr" 4,"May" 5,       "Jun" 6,"Jul" 7,"Aug" 8,"Sep" 9,"Oct" 10,"Nov" 11,"Dec" 12) offset 0.5,0;

plot       'car.csv' u 1:2 ls 1 pt 5 ti 'CAR model',       'car_ref.csv' u 1:2 ls 1 pt 4 ti 'CAR reference',       'ilocos.csv' u 1:2 ls 2 pt 7 ti 'Ilocos model',       'ilocos_ref.csv' u 1:2 ls 2 pt 6 ti 'Ilocos reference',       'calabarzon.csv' u 1:2 ls 4 pt 13 ti 'Calabarzon model',       'calabarzon_ref.csv' u 1:2 ls 4 pt 12 ti 'Calabarzon reference',       'cl.csv' u 1:2 ls 5 pt 3 ti 'Cent. Luz. model',       'cl_ref.csv' u 1:2 ls 5 pt 2 ti 'Cent. Luz. reference'

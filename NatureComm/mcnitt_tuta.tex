...
alone, the annual estimated intervention cost are \EURdig4 million and
\EURdig167 million per year, respectively. Due to extensive insecticide
...
%% Guimapi~et.~al.~\cite{guimapi2016modeling} ($25\mathrm{km}\times25\mathrm{km}$). 
...
%% \end{table}
%%
\paragraph{Domestic trade flows.}
...
Pending
============================================================
*if possible, talk about networks and how having regional production
information greatly improves the credibility of the models

...
set ylabel "Fraction of flows" offset -2,0 font ",18"


set notitle;        set key t r width 7;        set ytics offset 2,0;        set xtics offset 0,-.5;        set xlabel offset 0,.4;        set ylabel offset -.2,0;        set xtics font ",15";

...
##### output
set output 'prod_netout_flows_precip1_b2_k300.tex'
...
plot "../results/props_flows_precip1_b2_k300.csv" u 3 w boxes fs solid .5 ls 7 t "Production","../results/props_flows_precip1_b2_k300.csv" u 2 ls 4 lw 10 t "Net outflow";

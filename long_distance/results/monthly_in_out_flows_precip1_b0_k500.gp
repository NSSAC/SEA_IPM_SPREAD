...
##### output
set output 'monthly_in_out_flows_precip1_b0_k500.tex'
...
plot "../results/props_flows_precip1_b0_k500.csv" u 4 w boxes fs solid .5 ls 1 t "inflow","../results/props_flows_precip1_b0_k500.csv" u 5 w boxes fs solid .5 ls 2 t "outflow";

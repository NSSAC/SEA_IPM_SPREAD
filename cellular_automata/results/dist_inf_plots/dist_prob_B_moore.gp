...
##### output
set output 'dist_prob_B_moore.tex'
...
plot       'model-B_m1_60.csv' u 1:2 ls 1 pt 5 ti   '$\\r_M=1$',       'model-B_m2_60.csv' u 1:2 ls 1 pt 7 ti   '$\\r_M=2$',       'model-B_m3_60.csv' u 1:2 ls 1 pt 9 ti   '$\\r_M=3$',       '../obj/cell_count_distance.csv' u 1:2 ls 4 dashtype 2 ti  'max'

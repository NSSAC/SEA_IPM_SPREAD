...
##### output
set output 'IN_dist_prob_B_box.tex'
...
plot    'model-B_s2_48.csv' u (1.0):2:(.5):1 ls 1 fill solid .4 ti 'No interv.',    'model-B_s4_48.csv' u (1.0):2:(.3):1 ls 2 fill solid .4 ti 'Interv. 50\%',    'model-B_s5_48.csv' u (1.0):2:(.1):1 ls 3 fill solid .4 ti 'Interv. 100\%',    '.cell_count_rep.csv' u (1.0):2:(.1):1 ls 4 fill solid .4 ti 'max'

...
##### output
set output 'dist_prob_B_perc.tex'
...
set ylabel "Accumulated probabilities at $t=60$" offset -2,0 font ",15"


unset title;        set key r t width 5;        set xrange [1000:3000];        set xlabel offset 0,.7;        set xtics offset 0,-.4;

plot       'model-B_p0_m1_60.csv' u 1:2 ls 1 pt 5 ti  '1,0.0',       'model-B_p25_m1_60.csv' u 1:2 ls 1 pt 7 ti '1,0.25',       'model-B_p50_m1_60.csv' u 1:2 ls 1 pt 9 ti '1,0.50',       'model-B_p0_m2_60.csv' u 1:2 ls 2 pt 5 ti  '2,0.0',       'model-B_p25_m2_60.csv' u 1:2 ls 2 pt 7 ti '2,0.25',       'model-B_p50_m2_60.csv' u 1:2 ls 2 pt 9 ti '2,0.50',       'model-B_p0_m3_60.csv' u 1:2 ls 3 pt 5 ti  '3,0.0',       'model-B_p25_m3_60.csv' u 1:2 ls 3 pt 7 ti '3,0.25',       'model-B_p50_m3_60.csv' u 1:2 ls 3 pt 9 ti '3,0.50',       '../obj/cell_count_distance.csv' u 1:2 ls 4 dashtype 2 ti  'max'

...
##### output
set output 'dist_prob_A_box.tex'
...
unset title;        set key Right r t width 5;        set style data boxplot;        set style boxplot nooutliers;        set xlabel offset 0,-.7;        set xtics font ",12" rotate by -30 offset -2,-.1 scale 0 autojustify;

plot       'model-A_m1_60.csv' u (1.0):2:(.5):1 ls 1 fill solid .4 ti '$r_\textrm{M}$=1',       'model-A_m2_60.csv' u (1.0):2:(.3):1 ls 2 fill solid .4 ti '2',       'model-A_m3_60.csv' u (1.0):2:(.1):1 ls 3 fill solid .4 ti '3',       '.cell_count_rep.csv' u (1.0):2:(.1):1 ls 4 fill solid .4 ti 'max'

...
##### output
set output 'dist_prob_B_box.tex'
...
plot       'model-B_m1_60.csv' u (1.0):2:(.5):1 ls 1 fill solid .4 ti '$r_\textrm{M}$=1',       'model-B_m2_60.csv' u (1.0):2:(.3):1 ls 2 fill solid .4 ti '2',       'model-B_m3_60.csv' u (1.0):2:(.1):1 ls 3 fill solid .4 ti '3',       '.cell_count_rep.csv' u (1.0):2:(.1):1 ls 4 fill solid .4 ti 'max'

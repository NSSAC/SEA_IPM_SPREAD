...
##### output
set output 'dist_prob_B_int.tex'
...
set ylabel "Accumulated probabilities at $t=108$" offset -2,0 font ",15"


unset title;        set key r t width 5;        set xrange [1000:3000];        set xlabel offset 0,.7;        set xtics offset 0,-.4;

plot       'model-B_s2_m1_108.csv' u 1:2 ls 1 pt 5 ti  '1',       'model-B_s3_m1_108.csv' u 1:2 ls 1 pt 7 ti '1',       'model-B_s2_m2_108.csv' u 1:2 ls 2 pt 5 ti  '2',       'model-B_s3_m2_108.csv' u 1:2 ls 2 pt 7 ti '2',       'model-B_s2_m3_108.csv' u 1:2 ls 3 pt 5 ti  '3',       'model-B_s3_m3_108.csv' u 1:2 ls 3 pt 7 ti '3',       '../obj/cell_count_distance.csv' u 1:2 ls 4 dashtype 2 ti  'max'

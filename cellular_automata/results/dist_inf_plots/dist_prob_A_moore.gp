...
##### output
set output 'dist_prob_A_moore.tex'
...
unset title;        set key r t width 7;        set xrange [1000:3000];        set xlabel offset 0,.7;        set xtics offset 0,-.4;

plot       'model-A_m1_60.csv' u 1:2 ls 1 pt 5 ti   '$\\r_M=1$',       'model-A_m2_60.csv' u 1:2 ls 1 pt 7 ti   '$\\r_M=2$',       'model-A_m3_60.csv' u 1:2 ls 1 pt 9 ti   '$\\r_M=3$',       '../obj/cell_count_distance.csv' u 1:2 ls 4 dashtype 2 ti  'max'

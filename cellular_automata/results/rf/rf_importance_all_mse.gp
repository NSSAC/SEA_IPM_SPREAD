...
##### output
set output 'rf_importance_all_mse.tex'
...
set xlabel "\\%IncMSE" offset 0,0 font ",18"
...
plot '< gsort -t, -k2,2 -n -r ../results/rf/rf_importance_all.csv' u 2:(-$0):yticlabel(1) ls 1 pt 7

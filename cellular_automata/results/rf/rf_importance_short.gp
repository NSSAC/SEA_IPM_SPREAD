...
##### output
set output 'rf_importance_short.tex'
...
set xlabel "IncNodePurity" offset 0,-1 font ",16"
set ylabel "" offset -2,0 font ",16"


unset title;        set ytics textcolor 'black' offset .5,0;        set style data points;        set nokey;

plot '../results/rf/rf_importance_short.csv' u 3:(-$0):yticlabel(1) ls 2 pt 7

...
##### output
set output 'rf_importance_short_mse.tex'
...
##### key
set key t l Left spacing 3 width 5 opaque font ",16"

##### tics (note that tics are also set in theme)
set xtics font ",16" offset 0,-.1
set ytics font ",16" offset 1.5,-.2

##### plot
set title font ",16" "" offset -3,.3
set xlabel "\\%IncMSE" offset 0,-1 font ",16"
set ylabel "" offset -2,0 font ",16"


unset title;        set ytics textcolor 'black' offset .5,0;        set xtics font ",15";        set style data points;        set nokey;

plot '< gsort -t, -k2,2 -n -r ../results/rf/rf_importance_short.csv' u 2:(-$0):yticlabel(1) ls 2 pt 7

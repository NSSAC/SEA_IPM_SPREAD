...
##### output
set output 'concentration_with_popthresh.tex'
...
set xlabel "pop. threshold." offset 0,-.7 font ",12"
...
plot for [file in "concentrations_r50.csv concentrations_r75.csv concentrations_r100.csv"] file u 2:3 ti columnheader(1),         for [file in "concentrations_r50.csv concentrations_r75.csv concentrations_r100.csv"] file u 2:4 noti dashtype 2;

...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--season_file", default = "../../production/obj/ca_seasonal_production.csv")
    parser.add_argument("-c", "--city_file", default = "../obj/cities/cities_250000.csv")
    parser.add_argument("-o", "--out_file", default = "../obj/locality_data.csv")

...
"""
EPI="""Will use ZZZ for those which cannot be resolved."""
...
def main():
   ...
   parser.add_argument("-f","--from",default="name",action="store",help="format of input file (currently supports only \'name\'")
   ...
   parser.add_argument("-t","--to",default="alpha3",action="store",help="format of output file (currently supports alpha2/alpha3")

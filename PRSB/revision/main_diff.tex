...
%DIF ADD mcnitt_tuta.tex                        Sat Aug 31 06:10:38 2019
...
in Section~\DIFdelbegin \DIFdel{\ref{S:trans}}\DIFdelend \DIFaddbegin \DIFadd{\ref{S:modelAssumptions}}\DIFaddend .
...
remaining. \DIFaddbegin \DIFadd{In the following iteration, these subspaces are sampled
uniformly, and the process continues. }\DIFaddend Simulations were performed for more

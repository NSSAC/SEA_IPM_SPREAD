...
in Section~\ref{S:sec:modelAssumptions}.
...
Bangladesh (Table~\ref{S:tab:bgdData}). \\
...
\caption{\label{fig:thlBContour}} % Thailand without intervention
\end{subfigure}
\begin{subfigure}[b]{.135\textwidth}

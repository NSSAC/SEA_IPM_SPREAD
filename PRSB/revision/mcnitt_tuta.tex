...
\graphicspath{{./}{./figs/}{../../cellular_automata/results/contour/}{../../cellular_automata/results/rf/}{../../clustering/results/agglomerative/}{../../cellular_automata/results/dist_inf_plots/}}
%%
% CAPTIONS
\usepackage{caption}
...
\end{linenomath}
%%
%% Note that $\similarity(C)$ attains a maximum value of one when the
...
%% learned model is a decision tree that can be interpreted. This is similar
%% to approaches in the emerging field of interpretable machine
%% learning where decision-tree algorithms are used as surrogates for various
%% machine learning algorithms~\cite{molnar2019}.
...
\newblock {\em Ecology letters}, 18(2):188--199, 2015.

\bibitem{barrat2008dynamical}
A.~Barrat, M.~Barthelemy, and A.~Vespignani.
\newblock {\em Dynamical processes on complex networks}.
\newblock Cambridge university press, 2008.

\bibitem{biondi2018ecology}
A.~Biondi, R.~Guedes, and F.~Wan.
\newblock {Ecology, worldwide spread, and management of the invasive South
  American tomato pinworm, \emph{Tuta absoluta}: Past, present, and future}.
\newblock {\em Annual Review of Entomology}, (63):239--258, 2017.
...
\bibitem{carrasco2010unveiling}
L.~Carrasco, J.~Mumford, A.~MacLeod, T.~Harwood, G.~Grabenweger, A.~Leach,
  J.~Knight, and R.~Baker.
\newblock {Unveiling human-assisted dispersal mechanisms in invasive alien
  insects: integration of spatial stochastic simulation and phenology models}.
\newblock {\em Ecological Modelling}, 221(17):2068--2075, 2010.

\bibitem{cassandras2000clustering}
...
\bibitem{cunniffe2015thirteen}
N.~J. Cunniffe, B.~Koskella, C.~J.~E. Metcalf, S.~Parnell, T.~R. Gottwald, and
  C.~A. Gilligan.
\newblock {Thirteen challenges in modelling plant diseases}.
\newblock {\em Epidemics}, 10:6--10, 2015.

\bibitem{desneux2010biological}
N.~Desneux, E.~Wajnberg, K.~A. Wyckhuys, G.~Burgio, S.~Arpaia, C.~A.
  Narv{\'a}ez-Vasquez, J.~Gonz{\'a}lez-Cabrera, D.~C. Ruescas, E.~Tabone,
  J.~Frandon, et~al.
\newblock {Biological invasion of European tomato crops by {\emph{Tuta
  absoluta}}, ecology, geographic expansion and prospects for biological
  control}.
\newblock {\em Journal of Pest Science}, 83(3):197--215, 2010.

\bibitem{douma2016pathway}
J.~Douma, M.~Pautasso, R.~Venette, C.~Robinet, L.~Hemerik, M.~Mourits,
  J.~Schans, and W.~van~der Werf.
\newblock {Pathway models for analysing and managing the introduction of alien
  plant pests an overview and categorization}.
\newblock {\em Ecological Modelling}, 339:58--67, 2016.

\bibitem{early2016global}
R.~Early, B.~A. Bradley, J.~S. Dukes, J.~J. Lawler, J.~D. Olden, D.~M.
  Blumenthal, P.~Gonzalez, E.~D. Grosholz, I.~Iba{\~n}ez, L.~P. Miller, et~al.
\newblock {Global threats from invasive alien species in the twenty-first
  century and national response capacities}.
\newblock {\em Nature Communications}, 7, 2016.

\bibitem{epstein2008model}
J.~M. Epstein.
\newblock Why model?
\newblock {\em Journal of Artificial Societies and Social Simulation},
  11(4):12, 2008.

\bibitem{fadikar2018calibrating}
...
\bibitem{guidotti2019survey}
R.~Guidotti, A.~Monreale, S.~Ruggieri, F.~Turini, F.~Giannotti, and
  D.~Pedreschi.
\newblock A survey of methods for explaining black box models.
\newblock {\em ACM computing surveys (CSUR)}, 51(5):93, 2019.

\bibitem{guimapi2016modeling}
R.~Y. Guimapi, S.~A. Mohamed, G.~O. Okeyo, F.~T. Ndjomatchoua, S.~Ekesi, and
  H.~E. Tonnang.
\newblock {Modeling the risk of invasion and spread of {\emph{Tuta absoluta}}
  in Africa}.
\newblock {\em Ecological Complexity}, 28:77--93, 2016.

\bibitem{hulme2009trade}
P.~E. Hulme.
\newblock {Trade, transport and trouble: managing invasive species pathways in
  an era of globalization}.
\newblock {\em Journal of Applied Ecology}, 46(1):10--18, 2009.

\bibitem{karadjova2013tuta}
O.~Karadjova, Z.~Ilieva, V.~Krumov, E.~Petrova, V.~Ventsislavov, et~al.
\newblock {{\emph{Tuta absoluta}} (Meyrick) (Lepidoptera: Gelechiidae):
  Potential for entry, establishment and spread in Bulgaria}.
\newblock {\em Bulgarian Journal of Agricultural Science}, 19(3):563--571,
  2013.

\bibitem{kiss2006network}
...
\newblock {\em Journal of the Royal Society Interface}, 3(10):669--677, 2006.

\bibitem{lamperti2018agent}
F.~Lamperti, A.~Roventini, and A.~Sani.
\newblock Agent-based model calibration using machine learning surrogates.
\newblock {\em Journal of Economic Dynamics and Control}, 90:366--389, 2018.

\bibitem{martinetti2019identifying}
...
\newblock {\em Phytopathology}, 109(2):265--276, 2019.

\bibitem{moustier2015urban}
P.~Moustier and H.~Renting.
\newblock Urban agriculture and short chain food marketing in developing
  countries.
\newblock {\em Cities and Agriculture—Developing Resilient Urban Food
  Systems; de Zeeuw, H., Drechsel, P., Eds}, pages 121--138, 2015.

\bibitem{un_sustainable_development}
U.~Nations.
\newblock Sustainable development goals, Apr. 2019.

\bibitem{nopsa2015ecological}
J.~F.~H. Nopsa, G.~J. Daglish, D.~W. Hagstrum, J.~F. Leslie, T.~W. Phillips,
  C.~Scoglio, S.~Thomas-Sharma, G.~H. Walter, and K.~A. Garrett.
\newblock {Ecological networks in stored grain: Key postharvest nodes for
  emerging pests, pathogens, and mycotoxins}.
\newblock {\em BioScience}, page biv122, 2015.

\bibitem{pautasso2010disease}
...
\newblock {\em Journal of Applied Ecology}, 47(6):1300--1309, 2010.

\bibitem{pearson2007species}
R.~G. Pearson.
\newblock Species’ distribution modeling for conservation educators and
  practitioners.
\newblock {\em Synthesis. American Museum of Natural History}, 50:54--89, 2007.

\bibitem{strona2017network}
G.~Strona, C.~J. Carstens, and P.~S. Beck.
\newblock Network analysis reveals why \emph{{X}ylella fastidiosa} will persist
  in {E}urope.
\newblock {\em Scientific reports}, 7(1):71, 2017.

\bibitem{tonnang2015identification}
H.~E. Tonnang, S.~F. Mohamed, F.~Khamis, and S.~Ekesi.
\newblock {Identification and risk assessment for worldwide invasion and spread
  of {\emph{Tuta absoluta}} with a focus on Sub-Saharan Africa: implications
  for phytosanitary measures and management}.
\newblock {\em PloS one}, 10(8):e0135283, 2015.

\bibitem{USDA2012}
USDA.
\newblock {New Pest Response Guidelines: Tomato Leafminer (\emph{Tuta
  absoluta})}.
\newblock {\em Animal and Plant Health Inspection Service, Plant Protection and
  Quarantine}, 2012.

\bibitem{venkatramanan2019modeling}
...
\newblock {\em Crop Protection}, 2019.

\bibitem{wildemeersch2019modelling}
...
\newblock {\em Ecological Modelling}, 409:108745, 2019.

\bibitem{spam}
L.~You, U.~Wood-Sichra, S.~Fritz, Z.~Guo, L.~See, and J.~Koo.
\newblock {Spatial Production Allocation Model (SPAM) 2005 v3.2.}
...
\begin{subfigure}[b]{.2\textwidth}
    \includegraphics[width=\textwidth]{MSA_model-A_m2_l1.pdf}
    \caption{\label{fig:msaClassA}} % C
\end{subfigure}
\begin{subfigure}[b]{.2\textwidth}
    \includegraphics[width=\textwidth]{MSA_model-B_m1_l3.pdf}
    \caption{\label{fig:msaClassB}} % C
\end{subfigure}
\begin{subfigure}[b]{.135\textwidth}
    \includegraphics[width=\textwidth]{TH_model-B_precip1_m1_l3.pdf}
\caption{\label{fig:thlBContour}} % Tha
\end{subfigure}
\begin{subfigure}[b]{.135\textwidth}
    \includegraphics[width=\textwidth]{TH_model-B_precip1-out-100_m1_l3.pdf}
\caption{\label{fig:thlBContourInt}} % Thailand with intervention
\end{subfigure}
\begin{subfigure}[b]{.3\textwidth}
    \includegraphics[width=\textwidth]{TH_dist_prob_B_box.pdf}
\caption{\label{fig:thlBContourBox}} % Thailand: range of expansion (all Class B models)
\end{subfigure}

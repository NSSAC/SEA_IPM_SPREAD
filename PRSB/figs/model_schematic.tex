...
\newcommand*{\arrowcolor}{red!80!black}%
\newcommand*{\infcolor}{red!70!black}%
\newcommand*{\suscolor}{green!80!black}%
\newcommand*{\loccolor}{black!80}%
\newcommand*{\moorecolor}{\loccolor}%
\newcommand*{\loccolora}{blue!70!black!80}%
...
%arrow
    \draw[-latex,thick,\arrowcolor, opacity = \arrowopacity](4.5,0.4)node[right]{}
        ...
        %sei
        \draw[-latex,thick,black](5.6,-0.3)to node[below=8mm,block,fill=yellow] (E){E} (5.6, -2.5);
        \node[block,fill=\suscolor] at (3, -3.3)(S){S};
        
        \node[block,fill=\infcolor] at (8,-3.3) (I){I};
...
%% Label arrows
    ...
    \node[below=-2mm] at (loc) {radius};
        ...
        \draw[-latex,thick,black](-5.3,-1.7)node[left]{Locality}
         ...
         \draw[-latex,thick](1,6)node[right,black](loc){Long distance spread}
         to (-0.5,5.6);
         
         \draw[-latex,thick](2.2,4.5)node[above right=-3mm,black](loc){Farm to market spread}
         to (1,2.2);
         
         \draw[-latex,thick](-1.5,-2.8)node[below left=-3mm,black](loc){Short distance spread}
         to (-0.5,-2);

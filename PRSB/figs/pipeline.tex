...
%% locality
\node[blk,fill=\Orange,below of=temporal,shift={(0,-.2)}] (locality) {\textbf{\large Locality
...
%% gravity
\node[blk,fill=\Orange,left of=locality,shift={(-2.6,0)}] (gravity) {\textbf{\large Monthly trade flows
...
%% %% -- ($(anch)+(0,-3.2)$) -- cycle;
\draw[\DarkOrange,fill=\DarkOrange,ultra thick] ($(locality.east)+(.2,0)$) --

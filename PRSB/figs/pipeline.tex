...
\begin{tikzpicture}
    [blk/.style={inner sep=.1cm,draw=black!80,rounded corners,text width=3cm,minimum height=3cm},
every node/.style={inner sep=0,align=center},
blkedge/.style={draw=black!50,>=latex, shorten >=1pt, shorten <=1pt, line
width=1mm},
datedge/.style={draw,>=latex, shorten >=1pt, shorten <=1pt},
node distance=4.2cm,thick]

%% grid
\node[blk] (grid) {\textbf{\large Grid overlay}\\\smallskip Decomposition into cells};

...
%% spatial
\node[blk,fill=\Green,right of=grid] (spatial) {\textbf{\large Spatial \\ disaggregation of
...
%% temporal
\node[blk,fill=\Green,right of=spatial] (temporal) {\textbf{\large Temporal
    disaggregation} \\
...
%% locality
\node[blk,fill=\Yellow,below of=temporal,shift={(0,-.2)}] (locality) {\textbf{\large Locality
...
%% gravity
\node[blk,fill=\Yellow,left of=locality,shift={(-2.6,0)}] (gravity) {\textbf{\large Monthly trade flows
...
%% %% -- ($(anch)+(0,-3.2)$) -- cycle;
\draw[\DarkGreen,fill=\DarkGreen,ultra thick] ($(temporal.east)+(.2,0)$) --
...
%% %% -- ($(anch)+(0,-3.2)$) -- cycle;
\draw[\DarkYellow,fill=\DarkYellow,ultra thick] ($(locality.east)+(.2,0)$) --
